...
const def: TreeDefinition = {
  label: "Magic Tree",
  requiredLevel: 25,
  requiredAxeLabel: "Diamond Axe",
  requiredAxeTokens: ["diamond_axe", "axe_diamond", "diamondaxe", "diamond axe"],
  maxHealth: 14,
  respawnMs: 180_000,
...
const HIT_SFX = AUDIO.gathering.woodcutting.regular.hit;
const CRACK_SFX = AUDIO.gathering.woodcutting.regular.crack.phase1;
const HIT_VFX = "woodcutting.palm.hit.placeholder";
const FELLED_SFX = AUDIO.gathering.woodcutting.regular.break;
...
const GLOBAL_COOLDOWN_KEY = "__crpg_magic_tree_chop_cooldowns";
...
export function onBeginPlay(ctx: { buildableActorId: string }, api: any) {
  ...
  console.log("[TS][buildables] magic tree onBeginPlay, interact disabled", ctx.buildableActorId);
}
