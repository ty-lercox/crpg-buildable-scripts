...
> = {
  diamond: {
    label: "Diamond",
    dropLabel: "diamond ore",
    requiredLevel: 15,
    requiredPickaxeLabel: "Diamond Pickaxe",
    requiredPickaxeTokens: ["diamond_pickaxe", "pickaxe_diamond", "diamondpickaxe", "diamond pickaxe"],
    maxHealth: 12,
    respawnMs: 180_000,
...
const def = (ORE_DEFINITIONS as any)[ORE_TYPE] ?? ORE_DEFINITIONS.diamond;
...
const GLOBAL_COOLDOWN_KEY = "__crpg_diamond_mine_cooldowns";
...
export function onBeginPlay(ctx: { buildableActorId: string }, api: any) {
  ...
  console.log("[TS][buildables] diamond onBeginPlay, interact disabled", ctx.buildableActorId);
}
