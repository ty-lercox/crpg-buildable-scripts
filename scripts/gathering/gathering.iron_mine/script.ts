...
> = {
  iron: {
    ...
    dropLabel: "iron ore",
    requiredLevel: 5,
    requiredPickaxeLabel: "Stone Pickaxe",
    requiredPickaxeTokens: ["stone_pickaxe", "pickaxe_stone", "stonepickaxe", "stone pickaxe"],
    maxHealth: 7,
    respawnMs: 120_000,
...
const def = (ORE_DEFINITIONS as any)[ORE_TYPE] ?? ORE_DEFINITIONS.iron;
...
const GLOBAL_COOLDOWN_KEY = "__crpg_iron_mine_cooldowns";
...
export function onBeginPlay(ctx: { buildableActorId: string }, api: any) {
  ...
  console.log("[TS][buildables] iron onBeginPlay, interact disabled", ctx.buildableActorId);
}
