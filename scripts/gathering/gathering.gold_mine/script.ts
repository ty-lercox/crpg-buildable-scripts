...
> = {
  gold: {
    ...
    dropLabel: "gold ore",
    requiredLevel: 10,
    requiredPickaxeLabel: "Iron Pickaxe",
    requiredPickaxeTokens: ["iron_pickaxe", "pickaxe_iron", "ironpickaxe", "iron pickaxe"],
    maxHealth: 9,
    respawnMs: 150_000,
...
const def = (ORE_DEFINITIONS as any)[ORE_TYPE] ?? ORE_DEFINITIONS.gold;
...
const GLOBAL_COOLDOWN_KEY = "__crpg_gold_mine_cooldowns";
...
export function onBeginPlay(ctx: { buildableActorId: string }, api: any) {
  ...
  console.log("[TS][buildables] gold onBeginPlay, interact disabled", ctx.buildableActorId);
}
