...
const def: TreeDefinition = {
  label: "Willow",
  requiredLevel: 10,
  requiredAxeLabel: "Stone Axe",
  requiredAxeTokens: ["stone_axe", "axe_stone", "stoneaxe", "stone axe"],
  maxHealth: 7,
  respawnMs: 90_000,
...
const GLOBAL_COOLDOWN_KEY = "__crpg_willow_tree_chop_cooldowns";
...
export function onBeginPlay(ctx: { buildableActorId: string }, api: any) {
  ...
  console.log("[TS][buildables] willow onBeginPlay, interact disabled", ctx.buildableActorId);
}
