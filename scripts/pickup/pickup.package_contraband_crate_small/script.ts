const ITEM_LABEL = 'contraband crate';
const ITEM_CLASS_PATH = '/Game/CRPG/Items/Mining/Packages/Item_ContrabandCrateSmall.Item_ContrabandCrateSmall_C';
const ITEM_COUNT = 1;
const RESPAWN_DELAY_MS = 600_000;
