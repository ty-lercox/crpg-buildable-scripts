const CHEST_LABEL = 'Tier 3 reward chest';
const RESPAWN_DELAY_MS = 720_000;
...
const REWARD_TABLE: RewardEntry[] = [
  {
    label: 'gold ore',
    itemClassPath: '/Game/CRPG/Items/Mining/Item_GoldOre.Item_GoldOre_C',
    minCount: 1,
    maxCount: 2,
    weight: 6,
  },
  {
    label: 'diamond ore',
    itemClassPath: '/Game/CRPG/Items/Mining/Item_DiamondOre.Item_DiamondOre_C',
    minCount: 1,
    maxCount: 1,
    weight: 4,
  },
  {
    label: 'onyx',
    itemClassPath: '/Game/CRPG/Items/Mining/Gems/Item_Onyx.Item_Onyx_C',
    minCount: 1,
    maxCount: 1,
    weight: 3,
  },
  {
    ...
    itemClassPath: '/Game/CRPG/Items/Mining/Packages/Item_ContrabandCrateSmall.Item_ContrabandCrateSmall_C',
    minCount: 1,
    maxCount: 1,
    weight: 2,
  },
  {
    label: 'weapons crate',
    itemClassPath: '/Game/CRPG/Items/Mining/Packages/Item_WeaponsCrateSmall.Item_WeaponsCrateSmall_C',
    minCount: 1,
    maxCount: 1,
    weight: 2,
  },
  {
    label: 'scimitar',
    itemClassPath: '/Game/CRPG/Items/Weapons/Item_Scimitar.Item_Scimitar_C',
    minCount: 1,
    maxCount: 1,
    weight: 1,
  },
